...
import './HostingFormModal.css';

interface HostingFormModalProps {
  onClose: () => void;
}

const HostingFormModal: React.FC<HostingFormModalProps> = ({ onClose }) => {
  ...
  return (
    <div className="hosting-form-modal">
      <p className="form-description">Fill out the form below to volunteer for hosting</p>
